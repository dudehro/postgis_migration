...
DROP FUNCTION IF EXISTS ST_AsGeoJson (version int4, geog geography, maxdecimaldigits int4 , options int4 );
DROP FUNCTION IF EXISTS ST_AsGeoJson (version int4, geog geometry, maxdecimaldigits int4 , options int4 );
DROP FUNCTION IF EXISTS ST_AsKML (version int4, geom geography, maxdecimaldigits int4 , nprefix TEXT );
