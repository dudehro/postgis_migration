...
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
--
-- Generated on: 2021-05-31 09:48:24
...
DROP AGGREGATE IF EXISTS ST_AsMVT (anyelement, text, int4);
DROP AGGREGATE IF EXISTS ST_AsMVT (anyelement, text, int4, text);
DROP AGGREGATE IF EXISTS ST_AsMVT (anyelement, text, int4, text, text);
...
DROP FUNCTION IF EXISTS geometry_gist_distance_nd (internal,geometry,int4);
...
DROP FUNCTION IF EXISTS ST_AsEWKT (geometry, int4);
DROP FUNCTION IF EXISTS ST_AsTWKB (geom geometry, prec int4 , prec_z int4 , prec_m int4 , with_sizes boolean , with_boxes boolean );
DROP FUNCTION IF EXISTS ST_AsTWKB (geom geometry[], ids bigint[], prec int4 , prec_z int4 , prec_m int4 , with_sizes boolean , with_boxes boolean );
...
DROP FUNCTION IF EXISTS ST_SetSRID (geom geometry, srid int4);
...
DROP FUNCTION IF EXISTS ST_IsValidDetail (geom geometry, flags int4 );
...
DROP FUNCTION IF EXISTS ST_ClusterKMeans (geom geometry, k integer);
...
DROP FUNCTION IF EXISTS ST_LineFromEncodedPolyline (txtin text, nprecision int4 );
DROP FUNCTION IF EXISTS ST_AsEncodedPolyline (geom geometry, nprecision int4 );
...
DROP FUNCTION IF EXISTS ST_AsKML (geom geometry, maxdecimaldigits int4 , nprefix TEXT );
DROP FUNCTION IF EXISTS ST_AsGeoJson (geom geometry, maxdecimaldigits int4 , options int4 );
DROP FUNCTION IF EXISTS ST_AsGeoJson (r record, geom_column text , maxdecimaldigits int4 , pretty_bool bool );
...
DROP FUNCTION IF EXISTS pgis_asmvt_transfn (internal, anyelement, text, int4);
DROP FUNCTION IF EXISTS pgis_asmvt_transfn (internal, anyelement, text, int4, text);
DROP FUNCTION IF EXISTS pgis_asmvt_transfn (internal, anyelement, text, int4, text, text);
...
DROP FUNCTION IF EXISTS ST_AsText (geometry, int4);
...
DROP FUNCTION IF EXISTS ST_AsText (geography, int4);
...
DROP FUNCTION IF EXISTS geography_gist_distance (internal, geography, int4);
...
DROP FUNCTION IF EXISTS ST_AsGML (geog geography, maxdecimaldigits int4 , options int4 , nprefix text , id text );
DROP FUNCTION IF EXISTS ST_AsGML (text);
DROP FUNCTION IF EXISTS ST_AsKML (geog geography, maxdecimaldigits int4 , nprefix text );
...
DROP FUNCTION IF EXISTS ST_AsEWKT (geography, int4);
...
DROP FUNCTION IF EXISTS ST_SetSRID (geog geography, srid int4);
