...
DROP FUNCTION IF EXISTS AsSVG (geometry,integer);
DROP FUNCTION IF EXISTS AsSVG (geometry,integer,integer);
...
DROP FUNCTION IF EXISTS ST_AsGeoJson (version integer, geog geography, maxdecimaldigits integer , options integer );
DROP FUNCTION IF EXISTS ST_AsGeoJson (version integer, geog geometry, maxdecimaldigits integer , options integer );
DROP FUNCTION IF EXISTS ST_AsKML (version integer, geom geography, maxdecimaldigits integer , nprefix TEXT );
DROP FUNCTION IF EXISTS ST_AsKML (version integer, geom geometry, maxdecimaldigits integer , nprefix TEXT );
