...
DROP OPERATOR IF EXISTS <<->>  (geometry,geometry) CASCADE;
DROP OPERATOR IF EXISTS |=|  (geometry,geometry) CASCADE;
DROP OPERATOR IF EXISTS &&  (geography,geography) CASCADE;
DROP OPERATOR IF EXISTS <->  (geography,geography) CASCADE;
DROP OPERATOR IF EXISTS &&  (gidx,geography) CASCADE;
DROP OPERATOR IF EXISTS &&  (geography,gidx) CASCADE;
DROP OPERATOR IF EXISTS &&  (gidx,gidx) CASCADE;
DROP OPERATOR IF EXISTS <  (geography,geography) CASCADE;
DROP OPERATOR IF EXISTS <=  (geography,geography) CASCADE;
DROP OPERATOR IF EXISTS =  (geography,geography) CASCADE;
DROP OPERATOR IF EXISTS >=  (geography,geography) CASCADE;
DROP OPERATOR IF EXISTS >  (geography,geography) CASCADE;
DROP OPERATOR IF EXISTS ~  (box2df,geometry) CASCADE;
DROP OPERATOR IF EXISTS @  (box2df,geometry) CASCADE;
DROP OPERATOR IF EXISTS &&  (box2df,geometry) CASCADE;
DROP OPERATOR IF EXISTS ~  (geometry,box2df) CASCADE;
DROP OPERATOR IF EXISTS @  (geometry,box2df) CASCADE;
DROP OPERATOR IF EXISTS &&  (geometry,box2df) CASCADE;
DROP OPERATOR IF EXISTS &&  (box2df,box2df) CASCADE;
DROP OPERATOR IF EXISTS @  (box2df,box2df) CASCADE;
DROP OPERATOR IF EXISTS ~  (box2df,box2df) CASCADE;
DROP OPERATOR IF EXISTS &&&  (gidx,geometry) CASCADE;
DROP OPERATOR IF EXISTS &&&  (geometry,gidx) CASCADE;
DROP OPERATOR IF EXISTS &&&  (gidx,gidx) CASCADE;
-- Drop all casts.
...
DROP FUNCTION IF EXISTS ST_GeneratePoints (area geometry, npoints numeric);
...
DROP FUNCTION IF EXISTS ST_Subdivide (geom geometry, maxvertices integer );
...
DROP FUNCTION IF EXISTS ST_LineFromEncodedPolyline (text, int4 );
DROP FUNCTION IF EXISTS ST_AsEncodedPolyline (geom geometry, int4 );
